---
title: "Perfume Fragrance Families: The Collector's Practical Guide"
description: "Learn the 4 core perfume fragrance families and their subfamilies, then use the scent wheel to map your collection, spot gaps, and build a balanced fragrance wardrobe."
tier: "detail"
targetQuery: "perfume fragrance families"
relatedQueries:
  - "fragrance families guide"
  - "perfume scent families explained"
...
faqs:
  ...
  - q: "What is the fragrance wheel and who created it?"
    a: "The fragrance wheel is a circular diagram that groups perfumes into families and subfamilies based on shared olfactory characteristics. It was developed by fragrance expert Michael Edwards and is widely used by perfumers, retailers, and collectors to understand how scents relate to, blend with, and contrast each other."
  - q: "How do I figure out which fragrance family I prefer?"
    a: "Look at the bottles you already own and wear most often, then map their dominant notes to the four families. If seven out of ten bottles are Woody or Amber, that's your gravitational center. From there you can decide whether to go deeper in your comfort zone or consciously branch into an adjacent family."
  - q: "What is the difference between kindred and complementary notes on the fragrance wheel?"
    a: "Kindred notes are families that sit next to each other on the wheel. They share similar characteristics and blend harmoniously (e.g., Floral and Amber). Complementary notes sit opposite each other on the wheel. They contrast each other and can create complexity when layered, but can also feel jarring if you're not used to them."
  - q: "Which fragrance family is best for a collector who wants to cover all occasions?"
    a: "A well-rounded wardrobe typically includes at least one Fresh or citrus scent for daytime/summer, one Floral for versatile year-round use, one Woody for cooler weather and evenings, and one Amber/Oriental for winter and formal occasions. Building across all four families ensures you always have a contextually appropriate option to reach for."
  - q: "What is the Gourmand fragrance family?"
    a: "Gourmand is a modern subfamily, technically sitting within the Amber family on most wheels, built around edible notes like vanilla, caramel, chocolate, and tonka bean. It's the fastest-growing family among younger collectors and is beloved for cozy, skin-close wear in cold weather or evenings."
  - q: "Is Chypre a separate fragrance family?"
    a: "Chypre is one of the oldest and most respected fragrance accords, built on a classic core of bergamot, labdanum, patchouli, and oakmoss. On the modern Michael Edwards wheel it appears as a subfamily within Woody/Mossy, but many purists and niche collectors treat it as its own family due to its distinct structure and heritage."
published: true
---
...
| Family | Core character | Best occasions | Common notes |
|---|---|---|---|
| **Floral** | Romantic, elegant, feminine-to-unisex | Year-round, day/evening | Rose, jasmine, peony, tuberose |
| **Amber / Oriental** | Warm, sensual, enveloping | Evening, autumn/winter | Vanilla, labdanum, oud, benzoin |
...
- **Spring:** Floral, Soft Floral, Floral Fruity, lighter blooms and green freshness
- **Summer:** Fresh, Citrus, Aquatic/Water, projection drops with heat, so a lighter family helps
- **Autumn:** Woody, Floral Oriental, Fougère, transition scents that aren't yet full-weight
- **Winter:** Amber/Oriental, Gourmand, Woody Oriental, rich and enveloping, project well in the cold
