...
faqs:
  ...
  - q: "Why does Parfum sometimes project less than EDP?"
    a: "Because higher oil content means less alcohol, and alcohol is what launches scent molecules into the air. Parfum sits closer to the skin, evolving quietly over 8-12 hours. EDP has more alcohol to push the opening outward, giving it bigger initial sillage even though it fades sooner."
  - q: "Is EDT the same fragrance as EDP, just weaker?"
    a: "Not always. Many houses reformulate the composition when changing concentration, adjusting notes to suit the new oil ratio. Dior Sauvage EDT foregrounds bright bergamot and ambroxan, while the EDP introduces vanilla and star anise for a warmer, distinctly different character."
  - q: "How many sprays should I use for each concentration?"
    a: "A practical starting point: EDT, 3-5 sprays on pulse points; EDP, 2-4 sprays; Parfum, 1-2 dabs or sprays; Extrait, 1 spray maximum. Skin chemistry, ambient temperature, and the specific formula all affect diffusion, so start conservative and layer up over time."
  - q: "Can I track which concentration I prefer across my collection?"
    a: "Yes, and it's a revealing exercise. If you log your wears in an app like Perfume Picks, patterns emerge: you may find you consistently reach for EDPs on colder days and EDTs in summer. That data makes future purchases smarter and helps you identify gaps in your wardrobe by concentration."
published: true
---
...
## How does concentration interact with weather and season?
...
- **Spring/Summer:** Reach for EDTs and lighter EDPs, fresh, citrus, and aquatic families where the brighter top notes are the point.
- **Autumn/Winter:** EDPs and Parfums come into their own. Lower temperatures slow diffusion, and richer base notes (amber, woods, resins) need that concentration to project properly.
- **Layering:** An Eau de Cologne of a complementary scent over a dry-down EDP can extend wear and add complexity without overwhelming.
...
A practical starting point: EDT, 3-5 sprays on pulse points; EDP, 2-4 sprays; Parfum, 1-2 dabs or sprays; Extrait, 1 spray maximum. Skin chemistry, ambient temperature, and the specific formula all affect diffusion, so start conservative and build over time.
