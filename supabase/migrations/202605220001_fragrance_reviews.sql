-- 202605220001_fragrance_reviews.sql
-- Community fragrance reviews: one review per user per fragrance.
...
create index fragrance_reviews_fragrance_idx on fragrance_reviews (fragrance_id, helpful_count desc);
create index fragrance_reviews_user_idx      on fragrance_reviews (user_id);

create trigger fragrance_reviews_set_updated_at
